...
public class CompleteHistoryTransaction extends Fragment {
    Fragment currentFragment = null;
    public static CompleteHistoryTransaction newInstance() {
        CompleteHistoryTransaction fragment = new CompleteHistoryTransaction();
    ...
    {
        AdapterComponent.getAdapter(TransactionHistoryAdapter.class).getCompleteTransaksi(getUser().getId()).enqueue(new Callback<List<TransactionHistoryInProgress>>() {
            @Override
